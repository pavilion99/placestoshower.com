...
abstract class DynamicModel {
	...
	public static function create(array $array): self {
		...
		return new $name($db->getInsertId(), $array, $db);
	}
	...
	public static function all(): array {
		...
		$db->select(DBEngine::DB_ALL_COLUMNS, $name)->query();

		while ($row = $db->getRowArray()) {
			$ret[] = new $called($row["id"], $row, $db);
		}
	...
	public static function findBy(string $column, $value): ?self {
        ...
        return $val == null ? null : new $name($val, [], $db);
	}
